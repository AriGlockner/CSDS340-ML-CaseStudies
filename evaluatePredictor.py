...
from preditVessel import predictWithK, predictWithoutK
...
# Pass in a copy of the features and labels to prevent modification in predictWithK()
predVesselsWithK = predictWithK(testFeatures.copy(), numVessels, trainFeatures.copy(), trainLabels.copy())
...
predVesselsWithoutK = predictWithoutK(testFeatures.copy(), trainFeatures.copy(), trainLabels.copy())
